          ...
          <div className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                />
                <p className="mt-1 text-xs font-ui text-ink-muted/70">Letters, numbers, underscores only</p>
              </div>
              <div>
                <label className="block font-ui text-xs text-ink-muted uppercase tracking-wider mb-1.5">
                  Email
            ...
            <p className="mt-4 text-center font-ui text-ink-muted text-sm">
              ...
              <Link to="/login" className="text-wood hover:text-wood-dark transition-colors">
                Sign in
              </Link>
            </p>
          </div>
